...
export const DOCUMENT_TEMPLATES: DocumentTemplate[] = [
  {
    id: "passport-mock",
    label: "Passport (Mock)",
    description: "Synthetic passport layout for document capture review",
    path: "/documents/passport-mock.svg",
  },
  {
    id: "drivers-license-mock",
    label: "Driver's License (Mock)",
    description: "Synthetic ID card layout for document capture review",
    path: "/documents/drivers-license-mock.svg",
  },
  {
    id: "national-id-mock",
    label: "National ID (Mock)",
    description: "Synthetic national ID layout for document capture review",
